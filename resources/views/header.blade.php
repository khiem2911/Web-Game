...
<body>
        ...
        <a id="logohome" href="{{route('welcome')}}"><img style="width:50px;height:50px;" src="{{ asset('assets/img/shopgame.png') }}" > Fugame Shop </a>
            ...
            <ul class="navbar-nav">
                @guest
                    <li class="nav-item">
                        <a class="" href="{{ route('login') }}"><i class="fas fa-sign-in-alt"></i> Login</a> /
                        <a class="" href="{{ route('register') }}">Register</a>
                    </li>
                    
                @else
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('signout') }}"><i class="fas fa-sign-out-alt"></i></i> Logout</a>
                    </li>
                @endguest
            </ul>
            </div>
        ...
        <div class="container">
            <div class="img-container">
                <img src="{{asset('assets/img/persona.jpg') }}" alt="">
                <img src="{{asset('assets/img/resident.jpg') }}" alt="">
                <img src="{{asset('assets/img/game7.jpg') }}" alt="">
                <img src="{{asset('assets/img/honkai.jpg') }}" alt="">
            </div>
        </div>
        </div>
        @yield('content')
